...
namespace RailwayCore
{
    ...
    public partial class RailwayContext : DbContext
    {
        ...
        public virtual ObjectResult<GetJunktionStations_Result> GetJunktionStations()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetJunktionStations_Result>("GetJunktionStations");
        }
    }
}
